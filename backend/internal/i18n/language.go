...
var allLng = map[string]map[string]interface{}{
	"zh_cn": {
		...
		"system_initialized":           "系统已完成初始化",
		"alist_connect_fail":           "alist连接失败，请检查是否填写正确",
		"alist_url_invalid":            "AList地址必须是有效URL，非本机地址请使用HTTPS",
		...
		"task_not_running_stop":        "任务未在运行中，无法停止",
		"no_failed_task_items":         "没有可重试的未完成项",
		...
		"notify_send_fail":             "通知发送失败，请检查配置或稍后重试",
		"passwd_too_short":             "密码长度至少需要8位",
		"passwd_too_long":              "密码长度不能超过72字节",
	...
	"eng": {
		...
		"system_initialized":           "System has already been initialized",
		"alist_connect_fail":           "Alist connection failed, please check whether it is filled in correctly",
		"alist_url_invalid":            "AList URL must be valid; use HTTPS for non-local addresses",
		...
		"task_not_running_stop":        "The task is not running and cannot be stopped",
		"no_failed_task_items":         "No unfinished task items to retry",
		...
		"notify_send_fail":             "Notification send failed. Check the configuration or try again later",
		"passwd_too_short":             "Password must be at least 8 characters long",
		"passwd_too_long":              "Password must not exceed 72 bytes",
